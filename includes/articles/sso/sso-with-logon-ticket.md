...
The following article describes the process of running extractions for [pull destinations](https://help.theobald-software.com/en/xtract-universal/destinations#pull-and-push-destinations) using Single-Sign-On (SSO) with SAP Logon-Ticket.
...
- The {{ productName }} service must run under an [XU Service Account](https://help.theobald-software.com/en/xtract-universal/advanced-techniques/service-account).
...
![SSO-with-Logon-Ticket1](../assets/images/articles/sso/SSO-with-Logon-Ticket.png){:class="img-responsive"}
