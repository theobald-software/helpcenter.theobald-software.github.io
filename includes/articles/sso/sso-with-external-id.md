...
- The {{ productName }} service must run under a Windows AD Service account, see [Run an Xtract Universal Service under a Windows Service Account](https://help.theobald-software.com/en/xtract-universal/advanced-techniques/service-account).
...
![sap-external-id](../assets/images/articles/sso/sso-with-external-id.png){:class="img-responsive" width="700px"}
...
The distinguished name of the PSE owner can be the fully qualified hostname of the {{ productName }} server, e.g., `CN=xuserver.example.com`. 
