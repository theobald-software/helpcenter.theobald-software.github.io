...
| Data Extractions | There are no default SAP data extractions. To get started with {{ productName }}, [create an SAP connection](../getting-started.md/#connect-to-sap) and [create a new extraction](../getting-started.md/#create-an-extraction). | [Documentation: Getting Started](../getting-started.md) |
