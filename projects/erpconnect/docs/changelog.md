    ...
    <!-- Placeholder rows -->
      ...
      <tr class="placeholder-row">
        ...
        <td class="placeholder-cell">
          <img src="../version-history-new/link_broken.svg" alt="breaking-change" style="width:20px;">
          <img src="../version-history-new/critical.svg" alt="breaking-change" style="width:20px;">
        </td>
