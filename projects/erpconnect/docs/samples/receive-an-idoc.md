...
To configure your SAP system to send *MATMAS* IDocs, see [Setting Up a Test Environment for IDocs](../guide/idocs/prerequisites.md#set-up-a-test-environment-for-idocs).
...
1. Create an RFC Server object to accept calls from SAP, see [RFC Server](../guide/rfc-server/create-rfc-functions.md) for more information.
...
!!! note
    If you do not want to read the data buffer with offset and length of the texts, you can load an XML Schema instead, see [Using XMLs for IDocs](../guide/idocs/idocs-schema-generator.md).
