...
public class ERPTableAttribute : Attribute, _Attribute
```
...
[ERPTableAttribute](ERPConnect.Linq.ERPTableAttribute.md)
...
### <a id="ERPConnect_Linq_ERPTableAttribute__ctor"></a> ERPTableAttribute\(\)
...
### <a id="ERPConnect_Linq_ERPTableAttribute__ctor_System_String_"></a> ERPTableAttribute\(string\)
...
### <a id="ERPConnect_Linq_ERPTableAttribute_CustomFunctionName"></a> CustomFunctionName
...
### <a id="ERPConnect_Linq_ERPTableAttribute_Name"></a> Name
