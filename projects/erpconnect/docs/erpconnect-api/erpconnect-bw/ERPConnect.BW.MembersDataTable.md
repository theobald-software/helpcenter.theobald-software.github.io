...
### <a id="ERPConnect_BW_MembersDataTable_Count"></a> Count
...
### <a id="ERPConnect_BW_MembersDataTable_Item_System_Int32_"></a> this\[int\]
...
#### Property Value
 ...
 [MembersRow](ERPConnect.BW.MembersRow.md)

## Methods

### <a id="ERPConnect_BW_MembersDataTable_AddMembersRow_ERPConnect_BW_MembersRow_"></a> AddMembersRow\(MembersRow\)
...
`row` [MembersRow](ERPConnect.BW.MembersRow.md)

The MembersRow object to be added

### <a id="ERPConnect_BW_MembersDataTable_AddMembersRow_System_String_System_String_System_String_System_String_"></a> AddMembersRow\(string, string, string, string\)
...
### <a id="ERPConnect_BW_MembersDataTable_Clone"></a> Clone\(\)
...
### <a id="ERPConnect_BW_MembersDataTable_CreateInstance"></a> CreateInstance\(\)
...
### <a id="ERPConnect_BW_MembersDataTable_GetEnumerator"></a> GetEnumerator\(\)
...
### <a id="ERPConnect_BW_MembersDataTable_GetRowType"></a> GetRowType\(\)
...
### <a id="ERPConnect_BW_MembersDataTable_NewMembersRow"></a> NewMembersRow\(\)
...
### <a id="ERPConnect_BW_MembersDataTable_NewRowFromBuilder_System_Data_DataRowBuilder_"></a> NewRowFromBuilder\(DataRowBuilder\)
