...
### <a id="ERPConnect_BW_MembersRow_MemberCaption"></a> MemberCaption
...
### <a id="ERPConnect_BW_MembersRow_MemberName"></a> MemberName
...
### <a id="ERPConnect_BW_MembersRow_ParentUniqueName"></a> ParentUniqueName
...
### <a id="ERPConnect_BW_MembersRow_UniqueName"></a> UniqueName
...
### <a id="ERPConnect_BW_MembersRow_IsMemberCaptionNull"></a> IsMemberCaptionNull\(\)
...
### <a id="ERPConnect_BW_MembersRow_IsMemberNameNull"></a> IsMemberNameNull\(\)
...
### <a id="ERPConnect_BW_MembersRow_IsParentUniqueNameNull"></a> IsParentUniqueNameNull\(\)
...
### <a id="ERPConnect_BW_MembersRow_IsUniqueNameNull"></a> IsUniqueNameNull\(\)
...
### <a id="ERPConnect_BW_MembersRow_SetMemberCaptionNull"></a> SetMemberCaptionNull\(\)
...
### <a id="ERPConnect_BW_MembersRow_SetMemberNameNull"></a> SetMemberNameNull\(\)
...
### <a id="ERPConnect_BW_MembersRow_SetParentUniqueNameNull"></a> SetParentUniqueNameNull\(\)
...
### <a id="ERPConnect_BW_MembersRow_SetUniqueNameNull"></a> SetUniqueNameNull\(\)
