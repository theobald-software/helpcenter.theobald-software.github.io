...
### <a id="ERPConnect_Utils_BatchReturnCollection__ctor"></a> BatchReturnCollection\(\)
...
### <a id="ERPConnect_Utils_BatchReturnCollection_Item_System_Int32_"></a> this\[int\]
...
### <a id="ERPConnect_Utils_BatchReturnCollection_Add_ERPConnect_Utils_BatchReturn_"></a> Add\(BatchReturn\)
...
`NewBatchReturn` [BatchReturn](ERPConnect.Utils.BatchReturn.md)
