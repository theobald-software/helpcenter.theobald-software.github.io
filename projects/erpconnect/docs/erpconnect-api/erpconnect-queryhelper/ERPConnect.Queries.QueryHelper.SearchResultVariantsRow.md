...
### <a id="ERPConnect_Queries_QueryHelper_SearchResultVariantsRow_DescriptionText"></a> DescriptionText
...
### <a id="ERPConnect_Queries_QueryHelper_SearchResultVariantsRow_VariantName"></a> VariantName
...
### <a id="ERPConnect_Queries_QueryHelper_SearchResultVariantsRow_IsDescriptionTextNull"></a> IsDescriptionTextNull\(\)
...
### <a id="ERPConnect_Queries_QueryHelper_SearchResultVariantsRow_IsVariantNameNull"></a> IsVariantNameNull\(\)
...
### <a id="ERPConnect_Queries_QueryHelper_SearchResultVariantsRow_SetDescriptionTextNull"></a> SetDescriptionTextNull\(\)

```csharp
public void SetDescriptionTextNull()
```

### <a id="ERPConnect_Queries_QueryHelper_SearchResultVariantsRow_SetVariantNameNull"></a> SetVariantNameNull\(\)
