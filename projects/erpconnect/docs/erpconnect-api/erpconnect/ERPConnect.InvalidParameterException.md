...
The exception that is thrown when a parameter has an invalid value
(e. g. in connection string).

```csharp
public sealed class InvalidParameterException : ERPException, ISerializable, _Exception
```
