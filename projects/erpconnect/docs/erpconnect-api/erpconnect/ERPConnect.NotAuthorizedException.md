...
```csharp
public sealed class NotAuthorizedException : ABAPProgramException, ISerializable, _Exception
```
...
### <a id="ERPConnect_NotAuthorizedException__ctor_System_String_ERPConnect_ABAPProgramException_"></a> NotAuthorizedException\(string, ABAPProgramException\)
...
`innerException` [ABAPProgramException](ERPConnect.ABAPProgramException.md)
