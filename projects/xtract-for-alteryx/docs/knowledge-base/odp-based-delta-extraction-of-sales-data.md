---
title: ODP-based Delta Extraction of Sales and Customer Data from SAP  
description: Test
---
...
1. Drag & drop the Xtract ODP component into your Alteryx workflow :number-1:.<br>
...
3. Click **[Edit]** :number-3: to open the main window of the Xtract ODP component.
