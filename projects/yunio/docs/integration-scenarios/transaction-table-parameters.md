...
!!! tip
    Test the service and pass parameters in yunIO before integrating the service, see [Online Help - Testing a Service](https://help.theobald-software.com/en/yunio/run-services#testing-a-service).
